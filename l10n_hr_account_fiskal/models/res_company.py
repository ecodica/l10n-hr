...
class Company(models.Model):
    ...
    def _get_log_vals(self, msg_type, msg_obj, response, time_start, origin):
        ...
        if origin._name == "account.move":
            values.update(
                {
                    "fiskal_prostor_id": origin.l10n_hr_fiscal_device_id.l10n_hr_business_premise_id.id,
                    "fiskal_uredjaj_id": origin.l10n_hr_fiscal_device_id.id,
            ...
            values.update(
                {
                    "fiskal_prostor_id": origin.l10n_hr_business_premise_id.id,
